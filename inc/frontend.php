...
<!-- <button><?php esc_html_e( 'Generate content', 'wpwand' )?></button> -->
    ...
    <button class="wpwand-trigger wpwand-open">
       <svg width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23.4071 8.81326L21.3469 10.8735L17.1987 6.72536L19.259 4.66511C19.8397 4.08437 20.5864 3.80783 21.3331 3.80783C22.0797 3.80783 22.8264 4.08437 23.4071 4.66511C24.5548 5.81277 24.5548 7.66561 23.4071 8.81326Z" fill="white"/><path d="M20.3786 11.8557L5.43138 26.789C4.28372 27.9366 2.43088 27.9366 1.28323 26.789C0.135572 25.6413 0.135572 23.7885 1.28323 22.6408L16.2305 7.70752L20.3786 11.8557Z" fill="white"/><path d="M10.2032 3.28461L10.7701 1.36263C10.8254 1.18288 10.7701 0.989297 10.6457 0.851026C10.5212 0.712754 10.3 0.657445 10.1202 0.712754L8.19827 1.27967L6.2763 0.712754C6.09654 0.657445 5.90296 0.712754 5.76469 0.837198C5.62642 0.97547 5.58494 1.16905 5.64025 1.3488L6.19333 3.28461L5.62642 5.20658C5.57111 5.38632 5.62642 5.57992 5.75086 5.71819C5.88914 5.85646 6.08272 5.89794 6.26247 5.84263L8.19827 5.28955L10.1202 5.85646C10.1756 5.87029 10.217 5.88411 10.2723 5.88411C10.4106 5.88411 10.535 5.8288 10.6457 5.73201C10.7839 5.59374 10.8254 5.40016 10.7701 5.22041L10.2032 3.28461Z" fill="white"/><path d="M4.67233 11.5809L5.23924 9.65891C5.29455 9.47916 5.23924 9.28559 5.1148 9.14732C4.97652 9.00905 4.78294 8.96757 4.60319 9.02288L2.66739 9.57596L0.745399 9.00905C0.565646 8.95374 0.372079 9.00905 0.233807 9.13349C0.0955358 9.27177 0.0540545 9.46534 0.109363 9.6451L0.662449 11.5809L0.095536 13.5029C0.0402273 13.6826 0.0955359 13.8762 0.21998 14.0145C0.358252 14.1527 0.551819 14.1942 0.731572 14.1389L2.65355 13.572L4.57554 14.1389C4.61702 14.1527 4.67233 14.1527 4.72762 14.1527C4.86589 14.1527 4.99035 14.0974 5.10097 14.0006C5.23924 13.8624 5.28072 13.6688 5.22541 13.489L4.67233 11.5809Z" fill="white"/><path d="M25.412 18.4938L25.9789 16.5718C26.0342 16.392 25.9789 16.1985 25.8544 16.0602C25.7161 15.9219 25.5226 15.8804 25.3428 15.9358L23.4208 16.5027L21.4989 15.9358C21.3191 15.8804 21.1255 15.9358 20.9873 16.0602C20.849 16.1985 20.8075 16.392 20.8628 16.5718L21.4297 18.4938L20.8628 20.4158C20.8075 20.5955 20.8628 20.7891 20.9873 20.9274C21.1255 21.0656 21.3191 21.1071 21.4989 21.0518L23.4208 20.4849L25.3428 21.0518C25.3843 21.0656 25.4396 21.0656 25.4949 21.0656C25.6332 21.0656 25.7576 21.0103 25.8682 20.9135C26.0065 20.7753 26.048 20.5817 25.9927 20.4019L25.412 18.4938Z" fill="white"/></svg>
    </button>
        ...
        <div class="wpwand-floating-wraper">
            ...
            <!-- wp wand api missing notice  -->
                        ...
                        <div class="wpwand-api-missing-notice-wrap">
                            ...
                            <span><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.21895 5.78105C7.17755 4.73965 5.48911 4.73965 4.44772 5.78105L1.78105 8.44772C0.73965 9.48911 0.73965 11.1776 1.78105 12.219C2.82245 13.2603 4.51089 13.2603 5.55228 12.219L6.28666 11.4846M5.78105 8.21895C6.82245 9.26035 8.51089 9.26035 9.55228 8.21895L12.219 5.55228C13.2603 4.51089 13.2603 2.82245 12.219 1.78105C11.1776 0.73965 9.48911 0.73965 8.44772 1.78105L7.71464 2.51412" stroke="#EE2626" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg> Your API is not connected. Connect now to generate awesome contents.</span>
                            </div>
                        ...
                        <div class="wpwand-prompt-from-wrap">
                            ...
                            <div class="wpwand-prompt-item" id="templates">
                                <div class="wpwand-total-templates-count"><span>Total <?php echo esc_html( count( wpwand_templates() ) ) ?> templates</span></div>
        ...
        foreach ( wpwand_templates() as $template ):
            ...
            ?>
		                                            <div class="wpwand-tiemplate-item">
		                                                <h4>
		                                                    <?php echo esc_html__($template['title'], 'wpwand') ?>
		                                                    <?php if ( true == $template['is_pro'] ): ?>
		                                                        <span class="wpwand-pro-tag">PRO</span>
		                                                    <?php endif;?>
	                                                 </h4>
	                                                <p><?php echo esc_html__($template['description'], 'wpwand') ?></p>
	                                            ...
	                                            <div class="wpwand-prompt-form-wrap">
	                                                ...
	                                                <div class="wpwand-template-details">
	                                                    <h4><?php echo esc_html__($template['title'], 'wpwand') ?></h4>
	                                                    <p><?php echo esc_html__($template['description'], 'wpwand') ?></p>
	                                                </div>
	                                                <form action="" class="wpwand-prompt-form">
	                                                    <input type="hidden" id="wpwand-prompt" name="wpwand-prompt"
	                                                        value="<?PHP echo esc_html__($template['prompt'], 'wpwand') ?>">
                                            ...
                                            <div class="wpwand-form-group">
                                                <div class="wpwand-form-field">
                                                    ...
                                                    <input type="number" id="wpwand-word-limit" name="wpwand-word-limit"
                                                        value="100">
                                                </div>
                                            </div>
                                            <?php endif;?>
                                            ...
                                            <div class="wpwand-form-submit">
                                                <?php if ( $template['is_pro'] ): ?>
                                                    <a href="" class="wpwand-submit-pro"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7 10.25V11.75M2.5 14.75H11.5C12.3284 14.75 13 14.0784 13 13.25V8.75C13 7.92157 12.3284 7.25 11.5 7.25H2.5C1.67157 7.25 1 7.92157 1 8.75V13.25C1 14.0784 1.67157 14.75 2.5 14.75ZM10 7.25V4.25C10 2.59315 8.65685 1.25 7 1.25C5.34315 1.25 4 2.59315 4 4.25V7.25H10Z" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
</svg>
Get Pro to Use This Template</a>
  ...
  $('.wpwand-prompt-form-wrap').on('submit', function(e) {
    ...
    $this.find('.wpwand-content-wrap').html('<div class="wpwand-content skeleton"><div class="skeleton-left"><div class="line"></div><div class="line w50"></div><div class="line w75"></div></div></div>');
    ...
    $.post({
      ...
      success: function(response) {
        ...
        if( response == 'success' ) {
                        ...
                        $this.find('.wpwand-submit-button').html('Success!!').css('background-color', '#77C155')
                        // reload current page
                        window.location.reload();
        }else{
            $this.find('.wpwand-submit-button').html('Connect again').css('background-color', '#77C155')
            $this.find('.wpwand-form-submit').append('<span style="color:red">'+ response.data + '</span>');
        }
